...
class Brocken::Target::Architecture::X64 {
    ...
    method addsd_reg( $d, $s ) {
        ...
        my $si = $self->_reg_idx($s);
        $code
            .= pack( 'C', 0xF2 ) . $self->_rex( 0, $si, 0, $di ) . pack( 'CC', 0x0F, 0x58 ) . pack( 'C', 0xC0 | ( ( $si & 7 ) << 3 ) | ( $di & 7 ) );
    }
    ...
    method subsd_reg( $d, $s ) {
        ...
        my $si = $self->_reg_idx($s);
        $code
            .= pack( 'C', 0xF2 ) . $self->_rex( 0, $si, 0, $di ) . pack( 'CC', 0x0F, 0x5C ) . pack( 'C', 0xC0 | ( ( $si & 7 ) << 3 ) | ( $di & 7 ) );
    }
    ...
    method mulsd_reg( $d, $s ) {
        ...
        my $si = $self->_reg_idx($s);
        $code
            .= pack( 'C', 0xF2 ) . $self->_rex( 0, $si, 0, $di ) . pack( 'CC', 0x0F, 0x59 ) . pack( 'C', 0xC0 | ( ( $si & 7 ) << 3 ) | ( $di & 7 ) );
    }
    ...
    method divsd_reg( $d, $s ) {
        ...
        my $si = $self->_reg_idx($s);
        $code
            .= pack( 'C', 0xF2 ) . $self->_rex( 0, $si, 0, $di ) . pack( 'CC', 0x0F, 0x5E ) . pack( 'C', 0xC0 | ( ( $si & 7 ) << 3 ) | ( $di & 7 ) );
    }
    ...
    method ucomisd_reg( $d, $s ) {
        ...
        my $si = $self->_reg_idx($s);
        $code
            .= pack( 'C', 0x66 ) . $self->_rex( 0, $di, 0, $si ) . pack( 'CC', 0x0F, 0x2E ) . pack( 'C', 0xC0 | ( ( $di & 7 ) << 3 ) | ( $si & 7 ) );
    }
    ...
    method movq_reg_xmm( $d, $s ) {
        ...
        my $si = $self->_reg_idx($s);
        $code
            .= pack( 'C', 0x66 ) . $self->_rex( 1, $di, 0, $si ) . pack( 'CC', 0x0F, 0x6E ) . pack( 'C', 0xC0 | ( ( $di & 7 ) << 3 ) | ( $si & 7 ) );
    }
    ...
    method movq_xmm_reg( $d, $s ) {
        ...
        my $si = $self->_reg_idx($s);
        $code
            .= pack( 'C', 0x66 ) . $self->_rex( 1, $si, 0, $di ) . pack( 'CC', 0x0F, 0x7E ) . pack( 'C', 0xC0 | ( ( $si & 7 ) << 3 ) | ( $di & 7 ) );
    }
