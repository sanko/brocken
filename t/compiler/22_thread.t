...
subtest 'spawn_thread parsing' => sub {
    ...
    is $ast->stmts->[0]->name, 'spawn_thread', 'call name is spawn_thread';
    is scalar(@{$ast->stmts->[0]->args}), 1, 'one argument';
    ok $ast->stmts->[0]->args->[0]->isa('Brocken::AST::SubDecl'), 'arg is SubDecl';
};
