...
subtest 'set_default_policy sets class defaults' => sub {
    Brocken::Compiler->set_default_policy( fuel => 999, mem_limit => 5000, capabilities => 0x0F, );
...
subtest 'set_default_policy globals match' => sub {
    Brocken::Compiler->set_default_policy( fuel => 42, mem_limit => 1234, capabilities => 0xFF, );
