...
SKIP: {
    ...
    subtest 'f64 alloca load + fptosi' => sub {
        ...
        $builder->build_store( Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::f64(), value => 31.0 ), $fptr );
    ...
    subtest 'f64 constant direct fptosi' => sub {
        ...
        my $fptr = $builder->build_alloca( Brocken::Lindsay::IR::Type::f64(), '%fptr' );
        $builder->build_store( Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::f64(), value => 31.0 ), $fptr );
        my $fv = $builder->build_fptosi( Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::f64(), value => 31.0 ),
    ...
    subtest 'f64 fadd + fptosi' => sub {
        ...
        $builder->build_store( Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::f64(), value => 10.5 ), $fa );
        my $fva = $builder->build_load( Brocken::Lindsay::IR::Type::f64(), $fa, '%fva' );
        my $fb  = $builder->build_alloca( Brocken::Lindsay::IR::Type::f64(), '%fb' );
        $builder->build_store( Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::f64(), value => 20.5 ), $fb );
    ...
    subtest 'f64 add int const + float const' => sub {
        ...
        my $fval   = $builder->build_sitofp( $iconst, Brocken::Lindsay::IR::Type::f64(), '%fval' );
        my $fres
            = $builder->build_add( $fval, Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::f64(), value => 20.5 ), '%fres' );
        my $iret = $builder->build_fptosi( $fres, Brocken::Lindsay::IR::Type::i64(), '%iret' );
        $builder->build_ret($iret);
