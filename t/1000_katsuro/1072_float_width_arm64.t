    ...
    subtest 'float constant fptosi (f32 vs f64)' => sub {
        {
            ...
            my $b    = Brocken::Lindsay::IR::Builder->new();
            $b->position_at_end( $func->append_block('entry') );
            my $iv = $b->build_fptosi( Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::f32(), value => 31.0 ),
        ...
        }
        {
            ...
            my $b    = Brocken::Lindsay::IR::Builder->new();
            $b->position_at_end( $func->append_block('entry') );
            my $iv = $b->build_fptosi( Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::f64(), value => 31.0 ),
