...
subtest 'Br' => sub {
    ...
    my $br = Brocken::Lindsay::IR::Instruction::Br->new(
...
subtest 'Ret' => sub {
    ...
    my $ret = Brocken::Lindsay::IR::Instruction::Ret->new(
        type     => Brocken::Lindsay::IR::Type::i32(),
        opcode   => 'ret',
        operands => [$val],
    );
    like $ret->render, qr/ret i32 0/, 'Ret with value render';
    my $ret_void = Brocken::Lindsay::IR::Instruction::Ret->new(
        type     => Brocken::Lindsay::IR::Type::void(),
        opcode   => 'ret',
        operands => [],
    );
...
subtest 'Load/Store' => sub {
    ...
    my $store = Brocken::Lindsay::IR::Instruction::Store->new(
        type     => Brocken::Lindsay::IR::Type::void(),
        opcode   => 'store',
        operands => [ $val, $ptr ],
    );
...
subtest 'Call' => sub {
    my $callee = Brocken::Lindsay::IR::Function->new(
        name        => 'foo',
...
subtest 'Phi' => sub {
    ...
    my $phi = Brocken::Lindsay::IR::Instruction::Phi->new(
        name     => 'p',
        type     => Brocken::Lindsay::IR::Type::i32(),
        opcode   => 'phi',
    );
