...
sub build_box_int_func {
    ...
    my $func = Brocken::Lindsay::IR::Function->new( name => 'box_int', return_type => Brocken::Lindsay::IR::Type::ptr(), params => [ $mem, $val ] );
    my $b    = Brocken::Lindsay::IR::Builder->new();
    ...
    my $payload_ptr = $b->build_gep(
        Brocken::Lindsay::IR::Type::i8(),
        $mem, [ Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::i64(), value => 8 ) ],
        '%payload_ptr'
    );
...
sub build_incref_func {
    ...
    my $func = Brocken::Lindsay::IR::Function->new( name => 'incref', return_type => Brocken::Lindsay::IR::Type::void(), params => [$obj] );
    my $b    = Brocken::Lindsay::IR::Builder->new();
    $b->position_at_end( $func->append_block('entry') );
...
sub build_decref_func {
    my $obj  = Brocken::Lindsay::IR::Value->new( type => Brocken::Lindsay::IR::Type::ptr(), name => '%obj' );
    my $func = Brocken::Lindsay::IR::Function->new( name => 'decref', return_type => Brocken::Lindsay::IR::Type::void(), params => [$obj] );
    my $b    = Brocken::Lindsay::IR::Builder->new();
    my $e    = $func->append_block('entry');
...
subtest 'Jenny::Codegen Memory System' => sub {
    ...
    my $heap_end = $b->build_gep( Brocken::Lindsay::IR::Type::i8(),
        $heap, [ Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::i64(), value => 128 ) ], '%heap_end' );
    ...
    my $chunk = $b->build_call( $alloc,
        [ $cursor_slot, $limit_slot, Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::i64(), value => 16 ) ], '%chunk' );
    my $boxed
        = $b->build_call( $box, [ $chunk, Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::i64(), value => 42 ) ], '%boxed' );
    $b->build_call( $inc, [$boxed], undef );
    $b->build_call( $dec, [$boxed], undef );
    my $payload_ptr = $b->build_gep(
        Brocken::Lindsay::IR::Type::i8(),
        $boxed, [ Brocken::Lindsay::IR::Constant->new( type => Brocken::Lindsay::IR::Type::i64(), value => 8 ) ],
        '%payload_ptr'
    );
