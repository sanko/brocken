# lib/Brocken/Target/Format/DWARF.pm
use v5.38;
use feature 'class';
...
class Brocken::Target::Format::DWARF {
    ...
    method generate_line_table ( $filename, $mappings ) {
        ...
        my $files_data       = $filename . "\x00" . $self->encode_uleb128(1) . $self->encode_uleb128(0) . $self->encode_uleb128(0) . "\x00";
        my $program          = "";
        ...
        my $header             = pack( "S L C5", $version, $header_length, 1, 1, 251, 14, 13 );
